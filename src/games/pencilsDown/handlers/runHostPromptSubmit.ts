 ...
 * `GameRound.promptText` so non-host players can see what to draw, then
 * CAS-marks the action's output. Mirrors `makeSomeNoise/handlers/
 * runHostPromptSubmit.ts` — same shape, just imports the PD prompt schema.
